...
class HomeScreensadsplash extends StatefulWidget {
  const HomeScreensadsplash({Key? key}) : super(key: key);

  @override
  State<HomeScreensadsplash> createState() => _HomeScreenState();
}

class _HomeScreenState extends State<HomeScreensadsplash> {
  Measurements? size;
  HomeData? homeData;
